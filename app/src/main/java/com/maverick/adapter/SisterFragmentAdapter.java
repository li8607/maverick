...
import com.maverick.fragment.SisterItemFragment;
 ...
 */
public class SisterFragmentAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        return SisterItemFragment.newInstance(info);
    }
