    ...
    public static int[] getColors(Context context, int c) {
        if (c == ContextCompat.getColor(context, R.color.md_red_500)) {
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_pink_A200),
                    ContextCompat.getColor(context, R.color.md_pink_A400),
                    ContextCompat.getColor(context, R.color.md_pink_A700)
            };
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_purple_A200),
                    ContextCompat.getColor(context, R.color.md_purple_A400),
                    ContextCompat.getColor(context, R.color.md_purple_A700)
            };
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_deep_purple_A200),
                    ContextCompat.getColor(context, R.color.md_deep_purple_A400),
                    ContextCompat.getColor(context, R.color.md_deep_purple_A700)
            };
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_indigo_A200),
                    ContextCompat.getColor(context, R.color.md_indigo_A400),
                    ContextCompat.getColor(context, R.color.md_indigo_A700)
            };
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_blue_A200),
                    ContextCompat.getColor(context, R.color.md_blue_A400),
                    ContextCompat.getColor(context, R.color.md_blue_A700)
            };
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_light_blue_A200),
                    ContextCompat.getColor(context, R.color.md_light_blue_A400),
                    ContextCompat.getColor(context, R.color.md_light_blue_A700)
            };
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_cyan_A200),
                    ContextCompat.getColor(context, R.color.md_cyan_A400),
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_teal_A200),
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_green_A200),
                    ContextCompat.getColor(context, R.color.md_green_A400),
                    ContextCompat.getColor(context, R.color.md_green_A700)
            };
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_light_green_A700)
            };
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_lime_A200),
                    ContextCompat.getColor(context, R.color.md_lime_A400),
                    ContextCompat.getColor(context, R.color.md_lime_A700)
            };
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_yellow_A200),
                    ContextCompat.getColor(context, R.color.md_yellow_A400),
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_amber_A400),
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_orange_A400),
                    ContextCompat.getColor(context, R.color.md_orange_A700)
            };
            ...
            return new int[]{
                    ...
                    ContextCompat.getColor(context, R.color.md_deep_orange_A400),
                    ContextCompat.getColor(context, R.color.md_deep_orange_A700)
            };
