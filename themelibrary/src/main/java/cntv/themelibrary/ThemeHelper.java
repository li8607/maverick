...
public class ThemeHelper {
    ...
    public int getPrimaryColor() {
        switch (baseTheme) {
            case DARK:
                return getColor(cntv.themelibrary.R.color.md_grey_850);
            case AMOLED:
    ...
    public int getBackgroundColor() {
        switch (baseTheme) {
            case DARK:
                return getColor(cntv.themelibrary.R.color.md_dark_background);
            case AMOLED:
                return getColor(cntv.themelibrary.R.color.md_black_1000);
            case LIGHT:
            default:
    ...
    public int getTextColor() {
        switch (baseTheme) {
            case DARK:
            case AMOLED:
                return getColor(cntv.themelibrary.R.color.md_grey_200);
            case LIGHT:
            default:
                return getColor(cntv.themelibrary.R.color.md_grey_800);
        }
    }
    ...
    public int getSubTextColor() {
        switch (baseTheme) {
            case DARK:
            case AMOLED:
                return getColor(cntv.themelibrary.R.color.md_grey_400);
            case LIGHT:
            default:
                return getColor(cntv.themelibrary.R.color.md_grey_600);
        }
    }
    ...
    public int getCardBackgroundColor() {
        switch (baseTheme) {
            case DARK:
                return getColor(cntv.themelibrary.R.color.md_dark_cards);
            case AMOLED:
                return getColor(cntv.themelibrary.R.color.md_black_1000);
            case LIGHT:
            default:
                return getColor(cntv.themelibrary.R.color.md_light_cards);
        }
    }
    ...
    public int getIconColor() {
        switch (baseTheme) {
            case DARK:
            case AMOLED:
                return getColor(cntv.themelibrary.R.color.md_white_1000);
            case LIGHT:
            default:
                return getColor(cntv.themelibrary.R.color.md_light_primary_icon);
        }
    }
    ...
    public Drawable getPlaceHolder() {
        switch (baseTheme) {
            case DARK:
                return ContextCompat.getDrawable(context, cntv.themelibrary.R.drawable.ic_empty);
            case AMOLED:
                return ContextCompat.getDrawable(context, cntv.themelibrary.R.drawable.ic_empty_amoled);
            case LIGHT:
                return ContextCompat.getDrawable(context, cntv.themelibrary.R.drawable.ic_empty_white);
        }
        return null;
    }
    ...
    public ArrayAdapter<String> getSpinnerAdapter(ArrayList<String> items) {
        switch (baseTheme) {
            case AMOLED:
            case DARK:
                return new ArrayAdapter<>(context, R.layout.spinner_item_light, items);
            case LIGHT:
            default:
                return new ArrayAdapter<>(context, R.layout.spinner_item_dark, items);
        }
    }
    ...
    public int getDefaultThemeToolbarColor3th() {
        switch (baseTheme) {
            ...
            default:
            case AMOLED:
                return getColor(cntv.themelibrary.R.color.md_blue_grey_800);
        }
    }
