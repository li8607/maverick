...
public class ThemeHelper {
	...
	public void updateTheme(){
		this.primaryColor = SP.getInt(context.getString(cntv.themelibrary.R.string.preference_primary_color),
				getColor(cntv.themelibrary.R.color.md_indigo_500));
		this.accentColor = SP.getInt(context.getString(cntv.themelibrary.R.string.preference_accent_color),
				getColor(cntv.themelibrary.R.color.md_light_blue_500));
	...
	public void setBaseTheme(Theme baseTheme) {
		...
		SP.putInt(context.getString(cntv.themelibrary.R.string.preference_base_theme), getBaseTheme().getValue());
	}

	public static int getPrimaryColor(Context context) {
		PreferenceUtil SP = PreferenceUtil.getInstance(context);
		return SP.getInt(context.getString(cntv.themelibrary.R.string.preference_primary_color),
				ContextCompat.getColor(context, cntv.themelibrary.R.color.md_indigo_500));
	}
	...
	public static int getAccentColor(Context context) {
		PreferenceUtil SP = PreferenceUtil.getInstance(context);
		return SP.getInt(context.getString(cntv.themelibrary.R.string.preference_accent_color),
				ContextCompat.getColor(context, cntv.themelibrary.R.color.md_light_blue_500));
	}

	public static Theme getBaseTheme(Context context) {
		PreferenceUtil SP = PreferenceUtil.getInstance(context);
		return Theme.fromValue(SP.getInt(context.getString(cntv.themelibrary.R.string.preference_base_theme), Theme.LIGHT.value));
	}
	...
	public int getBackgroundColor(){
		switch (baseTheme){
			case DARK: return getColor(cntv.themelibrary.R.color.md_dark_background);
			case AMOLED: return getColor(cntv.themelibrary.R.color.md_black_1000);
			case LIGHT: default: return getColor(cntv.themelibrary.R.color.md_light_background);
		}
	}

	public int getInvertedBackgroundColor(){
		switch (baseTheme){
			case DARK: case AMOLED: return getColor(cntv.themelibrary.R.color.md_light_background);
	...
	public int getTextColor(){
		switch (baseTheme){
			case DARK: case AMOLED: return getColor(cntv.themelibrary.R.color.md_grey_200);
			case LIGHT: default: return getColor(cntv.themelibrary.R.color.md_grey_800);
		}
	}

	public int getSubTextColor(){
		switch (baseTheme){
			case DARK: case AMOLED: return getColor(cntv.themelibrary.R.color.md_grey_400);
			case LIGHT: default: return getColor(cntv.themelibrary.R.color.md_grey_600);
		}
	}

	public int getCardBackgroundColor(){
		switch (baseTheme){
			case DARK: return getColor(cntv.themelibrary.R.color.md_dark_cards);
			case AMOLED: return getColor(cntv.themelibrary.R.color.md_black_1000);
			case LIGHT: default: return getColor(cntv.themelibrary.R.color.md_light_cards);
		}
	}

	public int getIconColor(){
		switch (baseTheme){
			case DARK: case AMOLED: return getColor(cntv.themelibrary.R.color.md_white_1000);
			case LIGHT: default: return getColor(cntv.themelibrary.R.color.md_light_primary_icon);
		}
	}
	...
	public Drawable getPlaceHolder(){
		switch (baseTheme){
			case DARK: return ContextCompat.getDrawable(context, cntv.themelibrary.R.drawable.ic_empty);
			case AMOLED: return ContextCompat.getDrawable(context, cntv.themelibrary.R.drawable.ic_empty_amoled);
			case LIGHT: return ContextCompat.getDrawable(context, cntv.themelibrary.R.drawable.ic_empty_white);
		}
		return null;
	}
	...
	public int getDefaultThemeToolbarColor3th(){
		switch (baseTheme){
			case DARK: return getColor(cntv.themelibrary.R.color.md_black_1000);
			case LIGHT: default: case AMOLED: return getColor(cntv.themelibrary.R.color.md_blue_grey_800);
		}
	}
